...
-- Launcher
-- =============================================================================
bind(mainMod .. " + RETURN", group("Launcher") .. " open terminal", hl.dsp.exec_cmd("warp-terminal"))
...
bind(
  mainMod .. " + V",
  group("Launcher") .. " clipboard history",
  hl.dsp.exec_cmd("qs ipc call clipboard toggle")
)
bind(
  mainMod .. " + slash",
  group("Launcher") .. " keybindings hint",
  hl.dsp.exec_cmd(scripts .. "/keybinds_hint.sh")
)
bind(
  mainMod .. " + W",
  group("Launcher") .. " wallpaper picker",
...
bind(
  mainMod .. " + T",
  group("Window Management") .. " toggle float",
...
bind(
  mainMod .. " + h",
  group("Window Management|Move Focus") .. " focus left",
  hl.dsp.focus({ direction = "l" })
)
bind(
  mainMod .. " + l",
  group("Window Management|Move Focus") .. " focus right",
  hl.dsp.focus({ direction = "r" })
)
bind(
  mainMod .. " + k",
  group("Window Management|Move Focus") .. " focus up",
  hl.dsp.focus({ direction = "u" })
)
bind(
  mainMod .. " + j",
  group("Window Management|Move Focus") .. " focus down",
...
bind(
  mainMod .. " + S",
  group("Workspaces|Special") .. " toggle scratchpad",
...
bind(
  mainMod .. " + mouse_down",
  group("Workspaces|Navigation") .. " next workspace",
...
bind(
  mainMod .. " + P",
  group("Utilities") .. " screenshot",
  hl.dsp.exec_cmd(scripts .. "/screenshot.sh s")
)
bind(
  mainMod .. " + SHIFT + R",
  group("Utilities") .. " reload config",
  hl.dsp.exec_cmd("hyprctl reload")
)
bind(
  mainMod .. " + B",
  group("Utilities") .. " toggle quickshell",
