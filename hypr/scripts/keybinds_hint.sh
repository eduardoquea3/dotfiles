...
kb_hint_conf=("$keyconfDir/hyprland.conf" "$keyconfDir/keybinds.conf")
...
font_scale="${ROFI_KEYBIND_HINT_SCALE:-10}"
font_name="${ROFI_KEYBIND_HINT_FONT:-"JetBrainsMono Nerd Font"}"
